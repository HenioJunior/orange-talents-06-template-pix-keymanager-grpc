...
class RemoveChaveEndpoint(
    @Inject private val service: RemoveChaveService,) : ExcluiChaveGrpcServiceGrpc.ExcluiChaveGrpcServiceImplBase() {
    ...
    override fun exclui(request: ExcluiChaveRequest,
        ...
        val chaveExcluida = service.exclui(exclusaoRequest)
